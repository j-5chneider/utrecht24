...
> `r fontawesome::fa("file-circle-xmark", height="1.2em", width="1.2em")` Evidence that **"Data available upon reasonable request"** often does not keep its promise. Only **6.8% / 17%** of data sets were acutally provided in an investigation [@Gabelica.etal.2022; @Hussey.2023]
